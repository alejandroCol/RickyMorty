...
fun SerieCharacter.mapDomainToDto(): CharacterData = CharacterData(
    id,
    name,
    image,
    description
...
fun CharacterResponse.mapDomainToDto(): CharacterResponseData = CharacterResponseData(
    info,
    results.map { dto -> dto.mapDomainToDto() }
)
